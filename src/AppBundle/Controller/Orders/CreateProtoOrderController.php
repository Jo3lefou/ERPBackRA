...
use AppBundle\Form\RarStockOrderType;
...
class CreateProtoOrderController extends Controller
{
    /**
     * @Route("/{_locale}/protosorder/create/", name="createprotosorder")
     */
    public function newAction(Request $request, FileUpload $file_upload, MessageGenerator $messageGenerator)
    {
        ...
        if($user){
            ...
            $form = $this->createForm(RarStockOrderType::class, $newOrder )
