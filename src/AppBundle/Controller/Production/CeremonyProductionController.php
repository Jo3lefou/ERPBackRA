...
class CeremonyProductionController extends Controller
{
    /**
     *
     * @Route("/{_locale}/ceremonyproduction/view/{idshop}/{idworkroom}/{status}", name="ceremonyproductions")
     *
     */
    public function indexAction($idshop = 'all', $idworkroom = 'all', $status = 'all', UserInterface $user)
    {
        ...
        // On ne prend que les Cérmony
        $condition .= ' AND m.type = 2';
